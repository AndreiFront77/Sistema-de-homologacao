    ...
    <div class="dashboard-content">
      ...
      <div *ngIf="!loading && !error" class="content">
        ...
        <div class="dashboard-section-header">
          <h2>🐛 Bugs por Categoria</h2>
          <p class="description">Análise detalhada de bugs agrupados por categoria geral</p>
        </div>
        ...
        <div class="infografia-container">
          ...
          <div class="infografia-card danger">
            ...
            <div class="infografia-unit">Período atual</div>
          </div>

          <!-- Card Categorias -->
          <div class="infografia-card info">
            <span class="infografia-icon">📊</span>
            <div class="infografia-value">{{ categoriesData.length }}</div>
            <div class="infografia-label">Categorias</div>
        ...
        <div class="categories-grid">
          <div class="category-card" *ngFor="let item of categoriesData" [ngClass]="'status-' + item.status">
        ...
        <div class="table-container">
          ...
          <div class="table-responsive">
            <table class="table-data">
              ...
              <tbody>
                <tr *ngFor="let item of categoriesData">
                  <td>
                    <span class="category-badge">{{ item.icon }} {{ item.category }}</span>
                  </td>
...
export class BugCategoriaComponent implements OnInit, OnDestroy {
  ...
  private applyBugStats(bugs: Record<string, number>): void {
    ...
    this.categoriesData = entries.map((entry) => {
      const status: CategoryData['status'] = entry.count >= 10 ? 'danger' : entry.count >= 5 ? 'warning' : 'info';
